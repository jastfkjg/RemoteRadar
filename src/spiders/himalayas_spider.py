...
class HimalayasSpider:
    ...
    def _extract_job_id(self, url: str) -> Optional[str]:
        ...
        for pattern in patterns:
            ...
            if match:
                return f"hml_{match.group(1)}"
        
        if url:
            import hashlib
            return f"hml_{hashlib.md5(url.encode()).hexdigest()[:12]}"
    ...
    def crawl(self, categories: List[str] = None, max_jobs: int = 100,
        ...
        if categories and categories != ['all']:
            for cat in categories:
                urls_to_try.append(f"{self.BASE_URL}/jobs/{cat}/rss")
            ...
            try:
                ...
                for job_data in jobs:
                    ...
                    job_listing = JobListing(
                        ...
                        tags=tags if tags else 'remote, himalayas',
                    )
